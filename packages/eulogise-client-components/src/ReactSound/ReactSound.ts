// @ts-nocheck
// This is react-sound lib - please refer to https://github.com/leoasis/react-sound
import React from 'react'
import PropTypes from 'prop-types'

const pendingCalls: Array<any> = []
...
function createSound(options: any, cb: any) {
  if (soundManager.ok()) {
...
export class ReactSound extends React.Component {
