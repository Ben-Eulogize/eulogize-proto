...
;(function SM2(window, _undefined) {
  ...
  function SoundManager(smURL, smID) {
    ...
    this.setupOptions = {
      ...
      flashPollingInterval: 20, // msec affecting whileplaying/loading callback frequency. If null, default of 50 msec is used.
    ...
    this.hasHTML5 = (function () {
      try {
        ...
        return Audio !== _undefined && new Audio().canPlayType !== _undefined
      } catch (e) {
        return false
      }
    })()
    ...
    */
    ...
    testHTML5 = function () {
      ...
      var a = Audio !== _undefined ? new Audio() : null,
        item,
        lookup,
        support = {},
        aF,
    ...
    startTimer = function (oSound) {
      ...
      if (!oSound._hasTimer) {
        ...
        // ERIC - disabled mobileHtml5 requirement to fix the sluggishness for the slideshow player on mobile
